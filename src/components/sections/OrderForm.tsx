            ...
            <form className="space-y-6" onSubmit={onSubmit}>
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                  {[
                    { value: "9 PM (after 8 PM Mass)", label: "9 PM", desc: "Cuối Tuần 8 PM" },
                    { value: "9 AM (after 8 AM Mass)", label: "9 AM", desc: "Cuối Tuần 8 AM" },
                    { value: "11:30 AM (after 10:30 AM Mass)", label: "11:30 AM", desc: "Cuối Tuần 10:30 AM" }
                  ].map((option) => {
